...
inline static color color_on_texture(const scene& in_scene, const checker_texture& in_texture, const uv_mapping& in_uv, const position_3d& in_position)
{
...
inline static color color_on_texture(const scene& in_scene, const constant_texture& in_texture, const uv_mapping& in_uv, const position_3d& in_position)
{
